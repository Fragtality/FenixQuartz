    ...
    public static class InstallerFunctions
    {
        ...
        public static bool AutoStartExe()
        {
            ...
            try
            {
                ...
                {
                    if (outerNode.Name == "Launch.Addon" && outerNode.InnerText.Contains("FenixQuartz.exe"))
                    {
                        found = true;
                ...
                if (!found)
                {
                    ...
                    innerNode.InnerText = "FenixQuartz";
                    outerNode.AppendChild(innerNode);
        ...
        public static bool PlaceDesktopLink()
        {
            ...
            try
            {
                ...
                link.SetDescription("Start FenixQuartz");
                link.SetPath(Parameters.binPath);

                IPersistFile file = (IPersistFile)link;
                string desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
                file.Save(Path.Combine(desktopPath, "FenixQuartz.lnk"), false);
                result = true;
            }
            catch (Exception e)
            {
